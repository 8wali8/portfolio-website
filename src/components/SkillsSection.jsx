...
const skills = [
  ...
  // Web Development
  { name: "React", level: 90, category: "web", experience: "Jumpseat, MARA Hackathon, Medical Mutts (1000+ users)" },
  ...
  { name: "PostgreSQL", level: 85, category: "tools", experience: "Jumpseat (9M+ records, CRON automation)" },
